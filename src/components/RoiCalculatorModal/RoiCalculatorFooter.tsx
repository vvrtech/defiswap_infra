...
const RoiCalculatorFooter: React.FC<RoiCalculatorFooterProps> = ({
  ...
  const {
    ...
    <>
      <Text>
        {t(
          'The Multiplier represents the proportion ofDEFC rewards each farm receives, as a proportion of theDEFC produced each block.',
        )}
      </Text>
      <Text my="24px">
        {t('For example, if a 1x farm received 1DEFC per block, a 40x farm would receive 40DEFC per block.')}
      </Text>
