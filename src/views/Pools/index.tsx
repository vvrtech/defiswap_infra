...
const Pools: React.FC = () => {
  ...
  return (
    <>
<div style={{backgroundColor:theme.isDark?"#1f2335":"#fff"}}>
      <PageHeader style={{ backgroundImage: "url('/images/pool/DEFI.jpg')",position:"relative", backgroundRepeat: "no-repeat", backgroundSize: "cover", padding: "15px 0px" }} >
        ...
        <div ref={container} style={{height:"110%",position:"absolute",right:"10%",top:"-6.5%"}} />
          <Flex flex="1" flexDirection="column" mr={['8px', 0]} style={{zIndex:"100"}}>
      ...
      <Page>
        ...
        {showFinishedPools && (
          <FinishedTextContainer>
            <Text fontSize={['16px', null, '20px']} color="failure" pr="4px">
              {t('Looking for v1DEFC syrup pools?')}
            </Text>
        ...
        {viewMode === ViewMode.CARD ? cardLayout :
          (
