...
const Step1 = ({ hasProfile }: { hasProfile: boolean }) => {
  ...
  const { targetRef, tooltip, tooltipVisible } = useTooltip(
    <Box>
      ...
      <InlineLink external href="https://docs.defiswap.io/products/ifo-initial-farm-offering/icake">
  ...
  return (
    <CardBody>
      ...
      <Heading as="h4" color="secondary" mb="16px">
        {t('LockDEFC in theDEFC pool')}
      </Heading>
      <Box>
        <Text mb="4px" color="textSubtle" small>
          {t(
            'The maximum amount ofDEFC you can commit to the Public Sale equals the number of your iCAKE. Lock moreDEFC for longer durations to increase the maximumDEFC you can commit to the sale.',
          )}
        </Text>
  ...
  return (
    <CardBody>
      ...
      <Text color="textSubtle" small>
        {t('When the IFO sales are live, you can “commit” yourDEFC to buy the tokens being sold.')} <br />
      </Text>
      ...
      case 3:
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small>
              {t(
                'After the IFO sales finish, you can claim any IFO tokens that you bought, and any unspentDEFC tokens will be returned to your wallet.',
              )}
            </Text>
          </CardBody>
        )
