  ...
  return [
    ...
    },
    {
      ...
      description: [
        ...
        <LinkExternal href="https://docs.defiswap.io/contact-us/nft-market-applications">
          {t('Please apply here')}
        </LinkExternal>,
      ],
    },
    {
      ...
      description: [
        t(
          '100% of all platform fees taken by PancakeSwap from sales are used to buy back and BURNDEFC tokens in our weeklyDEFC burns.',
        ),
        t(
          'Platform fees: 2% is subtracted from NFT sales on the market. Subject to change.Collection fees: Additional fees may be taken by collection creators, once those collections are live. These will not contribute to theDEFC burns.',
        ),
      ],
    },
  ]
