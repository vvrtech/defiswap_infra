  ...
  return (
    <ModalInner mb="0">
      <Text as="p" mb="24px" fontSize="14px" color="textSubtle">
        {t(
          'Your voting power is determined by the amount ofDEFC you held at the block detailed below.DEFC held in other places does not contribute to your voting power.',
        )}
      </Text>
