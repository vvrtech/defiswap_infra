  ...
  const steps: Step[] = [
    {
      ...
      canHover: true,
      text: t('Unstake LP tokens andDEFC from the old MasterChef contract.'),
    },
    {
      stepId: ProgressStepsType.STEP2,
      canHover: true,
      text: t('Stake LP tokens andDEFC to the new MasterChef v2 contract.'),
    },
  ]
  ...
  return (
    <div ref={tableWrapperEl}>
      <PageHeader>
        ...
        <Link href="https://docs.defiswap.io/code/migration/migrate-your-stakings" external>
