...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms andDEFC pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm andDEFC pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect fromDEFC pool', data)
  }
