...
const LotteryCardContent = () => {
  ...
  const cakePrizesText = t('%cakePrizeInUsd% inDEFC prizes this round', { cakePrizeInUsd: cakePriceBusd.toString() })
    ...
    <>
      <Flex flexDirection="column" mt="48px">
        ...
        <Text color="white" mb="40px">
          {t('Buy tickets with CAKE, winDEFC if your numbers match')}
        </Text>
      </Flex>
